...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2021 at 10:05 AM
...
CREATE TABLE `event` (
  ...
  `type` enum('NORMAL','IMPORTANT') COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `event` (`event_id`, `room_id`, `isImportant`, `date`, `start_time`, `end_time`, `type`, `note`, `creator_id`) VALUES
(1, 1, 0, '2021-11-15', '20:12:23', '21:12:23', 'NORMAL', 'không cần tài liệu gì', 1);
...
ALTER TABLE `event`
  ...
  ADD KEY `isImportant` (`isImportant`);
